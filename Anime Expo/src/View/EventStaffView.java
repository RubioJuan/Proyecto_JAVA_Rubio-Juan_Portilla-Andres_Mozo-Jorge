...
public class EventStaffView {
    public static void main(String[] args) {
        EventStaffController controller = new EventStaffController();
        ...
        if(controller.AddEventStaff(eventstaff)){
            System.out.println("Personal añadido exitosamente.");
        } else {
            System.out.println("No se pudo añadir el personal.");
        }
        
        System.out.println("Lista de todos los empleado de personal:");

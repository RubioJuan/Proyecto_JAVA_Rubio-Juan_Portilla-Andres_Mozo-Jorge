...
private static void administrarEvento(Scanner scanner) {
    ...
    while (true) {
        ...
        System.out.println("║3. Panel de gestion contable                                                 ║");
            ...
            switch (opcion) {
                ...
                case 2:
                    System.out.println("Seleccionaste manejo de premios.");
                        ...
                        ActivityPrizeView activityPrizeView = new ActivityPrizeView(null); // Pasar nulo inicialmente
                ...
                case 6:
                    ...
                    QuestionCategoryView categoryView = new QuestionCategoryView(null); // Inicialmente nulo
                ...
                case 10:
                    ...
                    ParticipantView participantView = new ParticipantView(null); // Inicialmente nulo
                    ...
                    break;
                case 11:
                    System.out.println("Saliendo del panel de administración de eventos.");
                    return; 
